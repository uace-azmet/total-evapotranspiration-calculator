    ...
    figureSubtext <- 
      htmltools::p(
        htmltools::HTML(
          paste(
            standardText,
            "The value 'NA' indicates that the period of interest overlaps with the period from June 16, 2021 through October 10, 2021, when the ", azmetStation, " station was not in operation.",
            sep = " "
          )
        ),
