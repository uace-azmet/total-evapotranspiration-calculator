#' `fxn_totalET` - calculates seasonal ET totals from individual years
#' 
#' @param azmetStation - AZMet station selection by user
#' @param startDate - Start date of period of interest
#' @param endDate - End date of period of interest
#' @param etEquation - Evapotranspiration equation selection by user
#' @return `totalET` - Data table of seasonal ET totals from individual years


totalET <- function(azmetStation, startDate, endDate, etEquation) {
